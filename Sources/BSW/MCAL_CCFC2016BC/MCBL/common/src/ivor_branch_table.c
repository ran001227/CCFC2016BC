...
extern void IVOR_ExceptionHandler1(void);
extern void IVOR_ExceptionHandler2(void);
...
IVOR0trap:  b   IVOR0trap //  Critical Input interrupt handler
            ...
            .align SIXTEEN_BYTES
IVOR1trap:  b   IVOR_ExceptionHandler1 //  Machine check / (NMI) interrupt handler
//  ISI, ITLB Error on first instruction fetch for an exception handler
//  Parity Error signaled on cache access
//  External bus error
            .align SIXTEEN_BYTES
IVOR2trap:  b   IVOR_ExceptionHandler2 //  Data Storage interrupt handler
//  Access control.
