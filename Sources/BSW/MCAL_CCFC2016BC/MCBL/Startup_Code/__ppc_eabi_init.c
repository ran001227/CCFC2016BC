...
* 
* PROJECT     : CCFC2016BC           
* DESCRIPTION : Use this file for C or C++.  Contains calls to initialize memory pools
...
#define FLASH_DATA 0x18C980ED   /* For 160MHz versions */
#define FLASH_REG2 CFLASH.PFCR1.R
#define FLASH_DATA2 0x18C98081  /* For 160MHz versions */
