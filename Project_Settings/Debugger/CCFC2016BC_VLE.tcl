# This configuration script is compatible with CCFC2016BC MCUs.
# Features:
...
proc mpc567xf_init {} {
    ...
    if {$booke_vle == "vle"} {
        # VLE page
        reg ${TLB1_GROUP}MMU_CAM0 = 0x50000008fe000000fff00000fff00001
        reg ${TLB1_GROUP}MMU_CAM1 = 0x50000008da000000ffe00000ffe00001
        reg ${TLB1_GROUP}MMU_CAM2 = 0x70000010fe0000000000000000000001
        reg ${TLB1_GROUP}MMU_CAM3 = 0x40000010fe0000004000000040000001
        reg ${TLB1_GROUP}MMU_CAM4 = 0x40000010fe0000004004000040040001
        reg ${TLB1_GROUP}MMU_CAM5 = 0x50000008da000000c3f00000c3f00001
    } else {
        # BOOKE page
        reg ${TLB1_GROUP}MMU_CAM0 = 0x50000008fe000000fff00000fff00001
        reg ${TLB1_GROUP}MMU_CAM1 = 0x50000008da000000ffe00000ffe00001
    ...
    # CCFC2016BC, where x  = 3, 4; below key = x
    # 288K - 0x48000
    # 256K - 0x40000
    # 192K - 0x30000
    set mem_size(3) 0x30000
    set mem_size(4) 0x40000
    set mem_size(5) 0x48000
    set current_cfg 5
